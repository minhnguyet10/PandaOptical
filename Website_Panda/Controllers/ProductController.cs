...
namespace Website_Panda.Controllers
{
    public class ProductController : Controller
    {
        ...
        public async System.Threading.Tasks.Task<ActionResult> Create([Bind(Include = "IDProduct,ProductName,Title,Description,Image,MoreImage1,MoreImage2,Price,PromotionPrice,Quantity,Color,CategoryID,BrandID,CreatedDate,Status")] Product product, HttpPostedFileBase Image, HttpPostedFileBase MoreImage1, HttpPostedFileBase MoreImage2)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDProduct,ProductName,Title,Description,Image,MoreImage1,MoreImage2,MoreImage3,Price,PromotionPrice,Quantity,Color,CategoryID,BrandID,Detail,CreatedDate,Status")] Product product, HttpPostedFileBase Image, HttpPostedFileBase MoreImage1, HttpPostedFileBase MoreImage2)
        {
            if (ModelState.IsValid)
            {
